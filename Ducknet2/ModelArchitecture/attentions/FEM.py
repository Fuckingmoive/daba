...
class FEM(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        self.c2 = nn.Sequential(conv2d(in_c, out_c, kernel_size=3, padding=6, dilation=6), channel_attention(out_c))
        self.c3 = nn.Sequential(conv2d(in_c, out_c, kernel_size=3, padding=12, dilation=12), channel_attention(out_c))
        self.c4 = nn.Sequential(conv2d(in_c, out_c, kernel_size=3, padding=18, dilation=18), channel_attention(out_c))
