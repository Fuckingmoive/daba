...
import math
from Ducknet2.ModelArchitecture.attentions.PSA import PSA_p
...
class FSEM(nn.Module):
    def __init__(self, nIn):
        ...
        self.conv2_1 =conv2d(nIn, nIn//2, kernel_size=3,padding = 1,dilation=1,act=False)
        self.conv2_2 =conv2d(nIn//2, nIn//2, kernel_size=3,padding = 1,dilation=1,act=False)

        self.conv3_1 =conv2d(nIn, nIn //2, kernel_size=3,padding = 1,dilation=1,act=False)
        self.conv3_2 =conv2d(nIn //2, nIn //4, kernel_size=3,padding = 2,dilation=2,act=False)
        self.conv3_3 =conv2d(nIn //4, nIn //4, kernel_size=3,padding = 3,dilation=3,act=False)

        self.conv4_1 =conv2d(nIn, nIn //2, kernel_size=3,padding = 1,dilation=1,act=False)
        self.conv4_2 =conv2d(nIn //2, nIn //4, kernel_size=3,padding = 3,dilation=3,act=False)
        self.conv4_3 =conv2d(nIn //4, nIn //4, kernel_size=3,padding = 5,dilation=5,act=False)
