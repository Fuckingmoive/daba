...
import numpy as np
from Ducknet2.ModelArchitecture import DUCK_Net_skip4 as DUCK_Net
...
class DecoderBlock(nn.Module):
    def __init__(
        ...
        # self.attention1 = md.Attention(
        #       attention_type, in_chans=in_channels + skip_channels)
        ...
        # self.attention2 = md.Attention(
        #     attention_type, in_chans=out_channels)
...
class FCBSwinV2_Transformer(nn.Module):
    def __init__(self, size=384, checkpoint_path=None):
        ...
        self.duck = DUCK_Net.DuckNet(img_height=size, img_width=size, input_channels=3, out_classes=64, starting_filters=34)
